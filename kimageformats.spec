...
Source0  : https://download.kde.org/stable/frameworks/5.97/kimageformats-5.97.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.97/kimageformats-5.97.0.tar.xz.sig
...
%prep
%setup -q -n kimageformats-5.97.0
cd %{_builddir}/kimageformats-5.97.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660511442
mkdir -p clr-build
pushd clr-build
