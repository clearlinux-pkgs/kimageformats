...
Version  : 6.0.0
Release  : 94
URL      : https://download.kde.org/stable/frameworks/6.0/kimageformats-6.0.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.0/kimageformats-6.0.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.0/kimageformats-6.0.0.tar.xz.sig
...
%prep
%setup -q -n kimageformats-6.0.0
cd %{_builddir}/kimageformats-6.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711134283
mkdir -p clr-build
pushd clr-build
