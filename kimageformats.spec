...
Version  : 5.103.0
Release  : 69
URL      : https://download.kde.org/stable/frameworks/5.103/kimageformats-5.103.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.103/kimageformats-5.103.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.103/kimageformats-5.103.0.tar.xz.sig
...
%prep
%setup -q -n kimageformats-5.103.0
cd %{_builddir}/kimageformats-5.103.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676845608
mkdir -p clr-build
pushd clr-build
