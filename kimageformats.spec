...
Source0  : https://download.kde.org/stable/frameworks/5.58/kimageformats-5.58.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.58/kimageformats-5.58.0.tar.xz.sig
...
%prep
%setup -q -n kimageformats-5.58.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1557810560
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
