...
Version  : 5.104.0
Release  : 70
URL      : https://download.kde.org/stable/frameworks/5.104/kimageformats-5.104.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.104/kimageformats-5.104.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.104/kimageformats-5.104.0.tar.xz.sig
...
%prep
%setup -q -n kimageformats-5.104.0
cd %{_builddir}/kimageformats-5.104.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679513341
mkdir -p clr-build
pushd clr-build
