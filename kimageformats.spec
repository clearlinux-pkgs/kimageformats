...
Source0  : https://download.kde.org/stable/frameworks/6.1/kimageformats-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.1/kimageformats-6.1.0.tar.xz.sig
...
%setup -q -n kimageformats-6.1.0
cd %{_builddir}/kimageformats-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712950459
mkdir -p clr-build
pushd clr-build
