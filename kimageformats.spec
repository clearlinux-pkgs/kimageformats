...
Version  : 5.110.0
Release  : 81
URL      : https://download.kde.org/stable/frameworks/5.110/kimageformats-5.110.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.110/kimageformats-5.110.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.110/kimageformats-5.110.0.tar.xz.sig
...
%prep
%setup -q -n kimageformats-5.110.0
cd %{_builddir}/kimageformats-5.110.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694447232
mkdir -p clr-build
pushd clr-build
