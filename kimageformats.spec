...
Source0  : https://download.kde.org/stable/frameworks/5.60/kimageformats-5.60.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.60/kimageformats-5.60.0.tar.xz.sig
...
%prep
%setup -q -n kimageformats-5.60.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1563039786
mkdir -p clr-build
pushd clr-build
