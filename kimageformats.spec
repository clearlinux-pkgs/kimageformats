...
Version  : 5.112.0
Release  : 84
URL      : https://download.kde.org/stable/frameworks/5.112/kimageformats-5.112.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.112/kimageformats-5.112.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.112/kimageformats-5.112.0.tar.xz.sig
...
%prep
%setup -q -n kimageformats-5.112.0
cd %{_builddir}/kimageformats-5.112.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701991736
mkdir -p clr-build
pushd clr-build
