...
Source0  : https://download.kde.org/stable/frameworks/5.56/kimageformats-5.56.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.56/kimageformats-5.56.0.tar.xz.sig
...
%prep
%setup -q -n kimageformats-5.56.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1552152939
mkdir -p clr-build
pushd clr-build
