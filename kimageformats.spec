...
Source0  : https://download.kde.org/stable/frameworks/5.90/kimageformats-5.90.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.90/kimageformats-5.90.0.tar.xz.sig
...
%prep
%setup -q -n kimageformats-5.90.0
cd %{_builddir}/kimageformats-5.90.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641957039
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kimageformats-5.90.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kimageformats/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/kimageformats-5.90.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kimageformats/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kimageformats-5.90.0/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/kimageformats/3c3d7573e137d48253731c975ecf90d74cfa9efe
cp %{_builddir}/kimageformats-5.90.0/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/kimageformats/6f1f675aa5f6a2bbaa573b8343044b166be28399
cp %{_builddir}/kimageformats-5.90.0/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kimageformats/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/kimageformats-5.90.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kimageformats/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/kimageformats-5.90.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kimageformats/e458941548e0864907e654fa2e192844ae90fc32
pushd clr-build
%make_install
popd
