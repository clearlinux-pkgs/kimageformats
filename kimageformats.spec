...
Source0  : https://download.kde.org/stable/frameworks/5.62/kimageformats-5.62.0.tar.xz
Source1 : https://download.kde.org/stable/frameworks/5.62/kimageformats-5.62.0.tar.xz.sig
...
%prep
%setup -q -n kimageformats-5.62.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568866335
mkdir -p clr-build
pushd clr-build
