...
Version  : 6.13.0
Release  : 111
URL      : https://download.kde.org/stable/frameworks/6.13/kimageformats-6.13.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.13/kimageformats-6.13.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.13/kimageformats-6.13.0.tar.xz.sig
...
%setup -q -n kimageformats-6.13.0
cd %{_builddir}/kimageformats-6.13.0
pushd ..
cp -a kimageformats-6.13.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744647783
mkdir -p clr-build
pushd clr-build
