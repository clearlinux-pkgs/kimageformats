...
Source0  : https://download.kde.org/stable/frameworks/6.2/kimageformats-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.2/kimageformats-6.2.0.tar.xz.sig
...
%setup -q -n kimageformats-6.2.0
cd %{_builddir}/kimageformats-6.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715621040
mkdir -p clr-build
pushd clr-build
